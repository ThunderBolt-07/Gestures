    ...
    if(gesture!="randoms"){
      chrome.tabs.query({ currentWindow: true }, function (tabs) {
        ...
        if(gesture=="tab_left"){
          ...
          chrome.tabs.sendMessage(tabs[current_tab_index].id,{message:"scroll",direction:1},function(response) {});
  ...
  if (request.message === "cos") {
    ...
    try {
      ...
      if (!existingDocs) {
        ...
        console.error("Error creating offscreen document:", error, chrome.runtime.lastError);
      }
